...
class SchedulesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create schedule" do
    assert_difference('Schedule.count') do
      post schedules_url, params: { schedule: { movie_id: @schedule.movie_id, time: @schedule.time } }
    end
  ...
  test "should update schedule" do
    patch schedule_url(@schedule), params: { schedule: { movie_id: @schedule.movie_id, time: @schedule.time } }
